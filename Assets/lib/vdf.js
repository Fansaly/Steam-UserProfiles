// fixed `parse' method for compatible with ie7 by fansaly
...
var VDF = {
    parse: function(text) {
        ...
        for(; i < j; i++) {
            ...
            if( line == "" || line[0] == '/' || line.charAt(0) == '/') { continue; }

            // one level deeper
            if( line[0] == "{" || line.charAt(0) == "{" ) {
            ...
            while(true) {
                ...
                // vq_end = 7
                // val = 8
                var key = (m[2] !== undefined || m[2] !== '') ? m[2] : m[3];
                var val = (m[6] !== undefined || m[6] !== '') ? m[6] : m[8];
                ...
                if(val === undefined || val === '') {
                    ...
                    if((m[7] === undefined || m[7] === '') && (m[8] === undefined || m[8] === '')) {
                        line += "\n" + lines[++i];
                        continue;
                    }
